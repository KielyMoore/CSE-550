...
def submit():
    print('submit the loader data to the backend (below), this will spark the creation of the graphical plots')
    print("root_file:", file_label.cget("text"))
    print("start_date:", start_date.get())
    print("end_date:", end_date.get())
    print("user:", user.get())
    print("ACC_Mag:", ACC_Mag.get())
    print("Eda:", Eda.get())
    print("temp:", temp.get())
    print("movement_intensity:", movement_intensity.get())
    print("step_count:", step_count.get())
    print("rest:", rest.get())
    print("on_wrist:", on_wrist.get())
